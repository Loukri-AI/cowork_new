...
const i18n = defineMessages({
  ...
  thinking: {
    ...
    defaultMessage: 'CoWork is thinking…',
  },
  streaming: {
    id: 'loadingGoose.streaming',
    defaultMessage: 'CoWork is working on it…',
  },
  waiting: {
    id: 'loadingGoose.waiting',
    defaultMessage: 'CoWork is waiting…',
  },
  compacting: {
    id: 'loadingGoose.compacting',
    defaultMessage: 'CoWork is compacting the conversation...',
  },
  idle: {
