...
const i18n = defineMessages({
  ...
  disableAutoDownloadDesc: {
    ...
    defaultMessage:
      'When enabled, CoWork will notify you of new versions but will not download them automatically.',
  },
  ...
  autoDownload: {
    ...
    defaultMessage:
      'CoWork will download the update in the background and install it the next time you quit or restart.',
  },
});
