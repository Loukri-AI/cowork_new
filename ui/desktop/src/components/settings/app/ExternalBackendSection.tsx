...
const i18n = defineMessages({
  ...
  description: {
    ...
    defaultMessage:
      'By default CoWork starts a local backend. Use this to connect to an external ACP-compatible backend.',
  },
  useExternalServer: {
  ...
  serverUrlHelp: {
    ...
    defaultMessage:
      'Enter the HTTP(S) base URL. CoWork checks /status and connects to /acp under this base.',
  },
  workingDir: {
  ...
  workingDirPlaceholder: {
    ...
    defaultMessage: '/home/user/workspace',
  },
  workingDirHelp: {
  ...
  restartNote: {
    ...
    defaultMessage: 'Changes apply to new chat windows. Restart CoWork to update existing windows.',
  },
  urlProtocolError: {
