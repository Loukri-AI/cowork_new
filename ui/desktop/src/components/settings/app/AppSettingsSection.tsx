...
const i18n = defineMessages({
  ...
  appearanceDesc: {
    ...
    defaultMessage: 'Configure how CoWork appears on your system',
  },
  ...
  taskNotificationsDesc: {
    ...
    defaultMessage: 'Notify when CoWork finishes a task while the window is in the background',
  },
  menuBarIcon: { id: 'settings.menuBarIcon.title', defaultMessage: 'Menu bar icon' },
  menuBarIconDesc: {
    id: 'settings.menuBarIcon.description',
    defaultMessage: 'Show CoWork in the menu bar',
  },
  dockIcon: { id: 'settings.dockIcon.title', defaultMessage: 'Dock icon' },
  dockIconDesc: { id: 'settings.dockIcon.description', defaultMessage: 'Show CoWork in the dock' },
  preventSleep: { id: 'settings.preventSleep.title', defaultMessage: 'Prevent Sleep' },
  preventSleepDesc: {
    id: 'settings.preventSleep.description',
    defaultMessage:
      'Keep your computer awake while CoWork is running a task (screen can still lock)',
  },
  ...
  themeDesc: {
    ...
    defaultMessage: 'Customize the look and feel of CoWork',
  },
  languageTitle: { id: 'settings.language.title', defaultMessage: 'Language' },
  languageDesc: {
    id: 'settings.language.description',
    defaultMessage: 'Choose the display language for CoWork',
  },
  ...
  helpDesc: {
    ...
    defaultMessage: 'Help us improve CoWork by reporting issues or requesting new features',
  },
  ...
  updatesDesc: {
    ...
    defaultMessage: 'Check for and install updates to keep CoWork running at its best',
  },
  ...
  notificationsMacStep3: {
    ...
    defaultMessage: 'Find and select CoWork in the application list',
  },
